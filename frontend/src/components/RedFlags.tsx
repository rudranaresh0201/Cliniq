...
export default function RedFlags({ redFlags }: Props) {
  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-md" style={{ background: '#FFF7ED', border: '1px solid #FED7AA' }}>
      <div className="px-5 py-4 border-b" style={{ borderColor: '#FED7AA', background: '#FEF3C7' }}>
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: '#FEE2B0' }}>
        ...
        <ul className="space-y-2.5">
          {redFlags.map((flag, i) => (
            <li key={i} className="flex items-start gap-3">
              <svg className="w-4 h-4 shrink-0 mt-0.5" style={{ color: '#EA580C' }} fill="currentColor" viewBox="0 0 20 20">
